...
{/* 
            <div className="register__form-field">
              ...
              <input type="text" placeholder="Nhập tên tài khoản" name="userFullName" onChange={(e) => handleChange(e)} />
              <div className="text-warning">{userError.userFullName}</div>
            </div>

            <div className="register__form-field">
              <label htmlFor="">Số điện thoại</label>
              <input type="text" placeholder="Nhập tên tài khoản" name="userPhoneNumber" onChange={(e) => handleChange(e)} />
            ...
            <div className="register__form-field">
              ...
              <input type="password" placeholder="Nhập tên tài khoản" name="confirmPassword" />
            </div>
            ...
            <div className="register__form-singup">
              <p>Đã có tài khoản?</p>
              <p
